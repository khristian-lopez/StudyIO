...
const TopicsPage = (props) => {
  ...
  const handleOpen = (id) => {
    console.log('this is the id: ', id) // open room modal with topic_id
    setId(id);
    setOpenModal(true)
  }
  ...
  return (
    ...
    <Grid container spacing={1}>
      <Grid container item spacing={3}>
        <Grid item xs={3}><h1>Choose a Topic</h1></Grid>
        <Grid item xs={3}>< Motivational /></Grid>
        <Grid item xs={3}><TextField label="Find a Room" onChange={e=>searchHandler(e)}/></Grid>
      </Grid>
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={1}>
          <Grid container item spacing={3}>
